...
void Int_Init(void)
{
    ...
    RMP_ASSERT(RVM_A7M_Int_Local_Mod(KFN_INT_LOCAL_MOD, 30, RVM_A7M_KFN_INT_LOCAL_MOD_SET_STATE, 1U)==0);
    RMP_ASSERT(RVM_A7M_Int_Local_Mod(KFN_INT_LOCAL_MOD, 30, RVM_A7M_KFN_INT_LOCAL_MOD_SET_PRIO, 0xFFU)==0);
