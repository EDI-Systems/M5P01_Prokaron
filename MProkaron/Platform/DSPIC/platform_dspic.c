...
{
    ptr_t* Stack_Ptr;
    Stack_Ptr=(ptr_t*)(Stack-sizeof(ptr_t)*41);
...
Input          : ptr_t Ticks - Timer overflow value.
Output         : None.    
Register Usage : None.                                  
******************************************************************************/
void _RMP_Set_Timer(ptr_t Ticks)
{
